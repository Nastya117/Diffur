...
typedef ex (* iintegral_funcp_1)(const ex &, unsigned);
typedef ex (* iintegral_funcp_2)(const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_3)(const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_4)(const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_5)(const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_6)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_7)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_8)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_9)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_10)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_11)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_12)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_13)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
typedef ex (* iintegral_funcp_14)(const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, const ex &, unsigned);
...
typedef ex (* iintegral_funcp_exvector)(const exvector &, unsigned);
...
// the following lines have been generated for max. 14 parameters
    ...
    function_options & iintegral_func(iintegral_funcp_1 d);
    function_options & iintegral_func(iintegral_funcp_2 d);
    function_options & iintegral_func(iintegral_funcp_3 d);
    function_options & iintegral_func(iintegral_funcp_4 d);
    function_options & iintegral_func(iintegral_funcp_5 d);
    function_options & iintegral_func(iintegral_funcp_6 d);
    function_options & iintegral_func(iintegral_funcp_7 d);
    function_options & iintegral_func(iintegral_funcp_8 d);
    function_options & iintegral_func(iintegral_funcp_9 d);
    function_options & iintegral_func(iintegral_funcp_10 d);
    function_options & iintegral_func(iintegral_funcp_11 d);
    function_options & iintegral_func(iintegral_funcp_12 d);
    function_options & iintegral_func(iintegral_funcp_13 d);
    function_options & iintegral_func(iintegral_funcp_14 d);
...
// end of generated lines
	...
	function_options & iintegral_func(iintegral_funcp_exvector d);
...
protected:
	...
	bool has_iintegral() const { return iintegral_f != NULL; }
	...
	bool iintegral_use_exvector_args;
...
public:
	...
	ex iintegral(const symbol & s) const;
