...
void function_options::initialize()
{
	...
	nparams = 0;
	eval_f = evalf_f = real_part_f = imag_part_f = conjugate_f = derivative_f = iintegral_f
		= power_f = series_f = 0;
	...
	iintegral_use_exvector_args = false;
...
function_options & function_options::iintegral_func(iintegral_funcp_1 d)
{
	test_and_set_nparams(1);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_2 d)
{
	test_and_set_nparams(2);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_3 d)
{
	test_and_set_nparams(3);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_4 d)
{
	test_and_set_nparams(4);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_5 d)
{
	test_and_set_nparams(5);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_6 d)
{
	test_and_set_nparams(6);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_7 d)
{
	test_and_set_nparams(7);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_8 d)
{
	test_and_set_nparams(8);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_9 d)
{
	test_and_set_nparams(9);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_10 d)
{
	test_and_set_nparams(10);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_11 d)
{
	test_and_set_nparams(11);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_12 d)
{
	test_and_set_nparams(12);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_13 d)
{
	test_and_set_nparams(13);
	iintegral_f = iintegral_funcp(d);
	return *this;
}
function_options & function_options::iintegral_func(iintegral_funcp_14 d)
{
	test_and_set_nparams(14);
	iintegral_f = iintegral_funcp(d);
	return *this;
...
function_options& function_options::iintegral_func(iintegral_funcp_exvector d)
{
	iintegral_use_exvector_args = true;
	iintegral_f = iintegral_funcp(d);
	return *this;
}
...
ex function::iintegral(const symbol & s) const
{
	...
	case 2:
		return ((iintegral_funcp_2)(opt.iintegral_f))(seq[1-1], seq[2-1],iinteg_param);
	case 3:
		return ((iintegral_funcp_3)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1],iinteg_param);
	case 4:
		return ((iintegral_funcp_4)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1],iinteg_param);
	case 5:
		return ((iintegral_funcp_5)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1],iinteg_param);
	case 6:
		return ((iintegral_funcp_6)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1],iinteg_param);
	case 7:
		return ((iintegral_funcp_7)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1],iinteg_param);
	case 8:
		return ((iintegral_funcp_8)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1],iinteg_param);
	case 9:
		return ((iintegral_funcp_9)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1], seq[9-1],iinteg_param);
	case 10:
		return ((iintegral_funcp_10)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1], seq[9-1], seq[10-1],iinteg_param);
	case 11:
		return ((iintegral_funcp_11)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1], seq[9-1], seq[10-1], seq[11-1],iinteg_param);
	case 12:
		return ((iintegral_funcp_12)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1], seq[9-1], seq[10-1], seq[11-1], seq[12-1],iinteg_param);
	case 13:
		return ((iintegral_funcp_13)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1], seq[9-1], seq[10-1], seq[11-1], seq[12-1], seq[13-1],iinteg_param);
	case 14:
		return ((iintegral_funcp_14)(opt.iintegral_f))(seq[1-1], seq[2-1], seq[3-1], seq[4-1], seq[5-1], seq[6-1], seq[7-1], seq[8-1], seq[9-1], seq[10-1], seq[11-1], seq[12-1], seq[13-1], seq[14-1],iinteg_param);

        // end of generated lines
    }
    throw(std::logic_error("function::iintegral(): no iintegral function defined"));
