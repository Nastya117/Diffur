...
static ex exp_iinteg(const ex & x, unsigned iinteg_param)
{
...
static ex sin_iinteg(const ex & x, unsigned iinteg_param)
{
	GINAC_ASSERT(iinteg_param==0);
